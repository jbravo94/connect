...
public class ASTMLightModeSettingsDialog extends MirthDialog implements DocumentListener {
     ...
     */
    public ASTMLightModeSettingsDialog(ActionListener actionListener) {
    ...
    private void changeAbbreviation(DocumentEvent evt) {
        ...
        if (evt.getDocument().equals(startOfMessageBytesField.getDocument())) {
            ...
            actionListener.actionPerformed(new ActionEvent(startOfMessageBytesField, ActionEvent.ACTION_PERFORMED, ASTMLightModeClientProvider.CHANGE_START_BYTES_COMMAND));
            ...
            actionListener.actionPerformed(new ActionEvent(endOfMessageBytesField, ActionEvent.ACTION_PERFORMED, ASTMLightModeClientProvider.CHANGE_END_BYTES_COMMAND));
    ...
    private void initComponents() {
        ...
        startOfMessageBytesField.addActionListener(new ActionListener() {
        ...
        endOfMessageBytesField.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        ackBytesField.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        nackBytesField.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        maxRetryCountField.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        useMLLPv2YesRadio.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        useMLLPv2NoRadio.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void startOfMessageBytesFieldActionPerformed(ActionEvent evt) {//GEN-FIRST:event_startOfMessageBytesFieldActionPerformed
    ...
    private void endOfMessageBytesFieldActionPerformed(ActionEvent evt) {//GEN-FIRST:event_endOfMessageBytesFieldActionPerformed
