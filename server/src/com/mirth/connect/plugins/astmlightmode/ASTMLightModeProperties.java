...
public class ASTMLightModeProperties extends FrameModeProperties {

    public static final String PLUGIN_POINT = "ASTMLIGHT";
    ...
    public ASTMLightModeProperties() {
        super(PLUGIN_POINT);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ASTMLightModeProperties) {
            ASTMLightModeProperties props = (ASTMLightModeProperties) obj;
            //@formatter:off
